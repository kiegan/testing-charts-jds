...
```{r, out.width = '.33\\linewidth', fig.align = 'left', fig.cap = 'caption', fig.subcap = c('Cap 1', 'Cap 2', 'Cap 3', 'Cap 4', 'Cap 5', 'Cap 6'), fig.ncol = 3}

knitr::include_graphics("../SDSS-2023/images/vertical-ab.PNG")
knitr::include_graphics("../SDSS-2023/images/round3/horizontal-ab.PNG")
knitr::include_graphics("../SDSS-2023/images/round3/hwide-ab.PNG")
knitr::include_graphics("../SDSS-2023/images/vertical-cd.PNG")
knitr::include_graphics("../SDSS-2023/images/round3/horizontal-cd.PNG")
knitr::include_graphics("../SDSS-2023/images/round3/hwide-cd.PNG")
