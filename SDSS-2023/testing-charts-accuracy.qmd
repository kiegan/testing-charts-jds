...
-   Our work focuses on the following:
    ...
    -   \kr{Include somewhere in here:} The advantage of using a probability-based approach is two-fold.
...
Rather than asking the same (or similar) type of question with varied signal strength multiple hundred times, we are limited to only a few questions at a time.
...
**We vary the task by presenting viewers with different structural representations of the same data.**
