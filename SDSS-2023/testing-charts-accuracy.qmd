...
```{r}
#| label: fig-tasks
#| fig-cap: "Overview of all of the visual stimuli presented to viewers. In each bar chart, two pieces are marked. The larger piece in each chart are pieces B and D. "
#| out-width: 100%
...
| **Combined Rounds** | ---        |  `r nrow(round_123)` |  `r round(neff(round_123$weight),1)` |                                     |                                              |

: Survey rounds: dates, number of participants (nominal sample size), effective sample size, sum of weights, and factors for the combining of surveys as discussed above. {#tbl-rounds}
