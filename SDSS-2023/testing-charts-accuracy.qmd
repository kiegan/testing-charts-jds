...
We *combine* (rather than cumulate) $\ell \ge 2$ surveys $S_1$, $S_2$, ... $S_\ell$ as described in @omuircheartaighCombiningSamplesVs2002, by multiplying weights in $S_i$ by $\lambda_i$, for $1 \le i \le \ell$. $\lambda_i \in [0,1]$ with $\sum_i \lambda_i = 1$ is given as
$$
