...
\hh{
In order to measure the impact of the chart's context, we asked a subset of participants to assess the size of the two tiles A and B (as shown in the bottom right of @fig-tasks-explain) to each other without giving any additional information.}  
...
\hh{The beneficial effect of frames/context of the chart is apparent when comparing accuracy of responses for the Horizontal wide design and the floating bars: the rate of correct responses in floating bars is significantly lower than in the wide horizontal charts. }
