...
In \autoref{fig-tasks-3} we see two structural variations on the stacked bar chart seen in Test 1: first, the Task 1 chart sized equally but rotated 90 degrees with bar lengths shown horizontally.
