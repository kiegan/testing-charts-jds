...
round_123_certainty_long %>%
  ...
  geom_errorbar(
    aes(ymin = (estimate-1.96*std.error)/5,
        ymax = (estimate+1.96*std.error)/5),
    width=0.3,
    data = coefs_certainty
  ) + 
