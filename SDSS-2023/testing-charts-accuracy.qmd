---
title: "What do they see? Testing perceptual accuracy  in surveys of the of the general US population using stacked barcharts"
short-title: Testing stacked barcharts in surveys # running title
...
```{=latex}
  \newcommand{\rev1}[1]{{\textcolor{teal}{#1}}}
  \newcommand{\rev2}[1]{{\textcolor{purple}{#1}}}
  \newcommand{\editors}[1]{{\textcolor{ForestGreen}{#1}}}
...
Aligned tiles are additionally anchored in the same position along the axis, i.e. the difference between their sizes can be reduced to a positional assessment, which in the absence of three-dimensional cues seems to be the general strategy viewers use when evaluating barcharts [@zacksReadingBarGraphs1998a].
...
However, unaligned bars in a stacked barchart are not just assessments of the lengths of bars -- the other tiles in the chart provide a reference frame of the shared axis, which *should* help with an assessment of the tiles' sizes.
