...
<!--\kr{The updated sketch is great here!! One note -- can we move the label for the "positions along the same, but unaligned scale", it's not aligned with the others}--> <!--\hh{What about the sketch now?}-->
