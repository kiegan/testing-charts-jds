...
<!--Our work centers on studying data visualization design choices and their impact on viewer behavior and accuracy of viewers' responses.-->
...
```{r}
#| label: fig-zoom-123
#| fig-cap: "Rates of zooming by task, chart design, and correctness. There are significantly higher rates of zooming by respondents for the vertical task compared to both horizontal tasks; rates of zooming do not differ by correctness of response or alignment in the stimulus."
#| fig-height: 4.25
#| fig-width: 7
#| out-width: 80%
