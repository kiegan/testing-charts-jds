...
```{r run-to-update-bibfile, eval=TRUE, include=FALSE}
...
The three comparisons in the middle show interesting patterns, highlighted in the reordered @fig-response-67b.
