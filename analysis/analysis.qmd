...
```{r demographics}
logit_demo <- svyglm(correct~task:(gender+educ5+age4+income4), design=survey_123, family=quasibinomial())
logit_demo3 <- svyglm(correct3~task:(gender+educ5+age4+income4), design=survey_123, family=quasibinomial())
