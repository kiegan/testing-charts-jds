...
-   Minor comments
    ...
    XXX HH: What should we do here? I'd be OK with putting all of this into a table. KR: I'm ok with moving to a table, though I like having at least one visual to really highlight the difference between aligned/unaligned. This would help us be responsive to the other comments about overuse of visuals, though. 
...
-   **Is there a reason why the meaning/values of i from 1 to 3 are reversed between the two models specified in Equations 4 and 7?**
    ...
    -   KR: **Heike, please confirm** which order they should be in. 
    - hh: the order in 4 is the correct one, and was actually the one used for the table. I have fixed the description for eqn 7.
