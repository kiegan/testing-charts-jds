...
-   Minor comments
    ...
    HH: figure 6: changed labels to horizontal - a vertical display of the results allows a comparison across all tasks and designs. A wide layout of the chart allows us to keep the number of pages down. 
    XXX: Kiegan, could you make sure that the workaround actually works in the pdf? I think that my pdf looks different from the one you get.
    
    I'm not sure how much we can really go into liking something and engaging with charts. 
    Signals from aesthetic changes are usually quite small and people like different things. Finding aesthetic changes that suit everybody is rare.
...
HH *we have expanded the discussion on the interpretation of connected letters, and included an example for their first use.*
